...
(function() {
  ...
  function renderMonthlyHero(data, doc) {
    var placeholder = doc.getElementById('monthly-hero-placeholder');
    if (!placeholder) return;

    var currentKey = data.current;
    var article = data.articles[currentKey];
    if (!article) return;
  ...
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = {
      ...
      renderMonthlyHero: renderMonthlyHero
    };
  }
  if (typeof document === 'undefined') return;
  if (typeof monthlyData === 'undefined') return;
  renderMonthlyHero(monthlyData, document);
})();
