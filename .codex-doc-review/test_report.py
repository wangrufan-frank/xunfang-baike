...
class ReportTests(unittest.TestCase):
    ...
    def test_ooxml_contains_no_tool_identifying_metadata(self):
        # Exact tool markers avoid matching unrelated built-in style names.
        markers = (b"generated by python-docx", b"python-docx")
        violations = []
        ...
        self.assertEqual(
            violations,
            [],
            f"tool-identifying metadata found in OOXML parts: {violations}",
        )
